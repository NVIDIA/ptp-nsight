...
RTEV_ATTRIB_MACHINEID		= "Machine ID"
RTEV_ATTRIB_NODE_NAME		= "Node Name"
RTEV_ATTRIB_NODE_NUMBER		= "Node Number"
RTEV_ATTRIB_NODE_STATE		= "Status"
RTEV_ATTRIB_NODE_GROUP		= "Group Owner"
RTEV_ATTRIB_NODE_USER		= "User Owner"
RTEV_ATTRIB_NODE_MODE		= "Mode"

JOB_STATE_INIT             = 1
JOB_STATE_RUNNING          = 2
JOB_STATE_TERMINATED       = 3
JOB_STATE_ERROR            = 4
