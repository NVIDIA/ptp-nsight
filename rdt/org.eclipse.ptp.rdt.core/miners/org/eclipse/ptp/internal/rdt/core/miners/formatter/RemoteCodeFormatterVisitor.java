...
/**
 * This class is responsible for formatting Remote C/C++ source code.
 ...
 * @since 4.2
 */
public class RemoteCodeFormatterVisitor extends CPPASTVisitor {
	...
	private void reportFormattingProblem(RuntimeException e) {
		UniversalServerUtilities.logDebugMessage(LOG_TAG, "No index files found", fDStore); //$NON-NLS-1$
	}
