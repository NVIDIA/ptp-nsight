...
//	private CRefactoringActionGroup fRefactoringActionGroup;
	...
	public void createPartControl(Composite parent) {
    	...
    	PlatformUI.getWorkbench().getHelpSystem().setHelp(fPagebook, IRHelpContextIds.REMOTE_CALL_HIERARCHY);
    }
...
//        memento.putString(KEY_FILTER_MACROS, String.valueOf(fFilterMacrosAction.isChecked()));
    ...
    private void createActions() {
    	...
    	fOpenViewActionGroup.setSuppressTypeHierarchy(true); // TEMPORARY, type hierarchy should work
