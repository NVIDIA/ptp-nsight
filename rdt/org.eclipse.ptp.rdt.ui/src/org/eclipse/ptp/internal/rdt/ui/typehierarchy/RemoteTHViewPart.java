...
//		}
    ...
    private void createContextMenu() {
    	...
    	site.registerContextMenu(UIPlugin.TYPE_HIERARCHY_VIEW_ID, manager, fHierarchyTreeViewer); 
    	...
    	site.registerContextMenu(UIPlugin.TYPE_HIERARCHY_VIEW_ID + ".members", manager, fMemberViewer); //$NON-NLS-1$
    }
