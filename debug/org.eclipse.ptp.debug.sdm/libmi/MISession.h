...
struct MISession {
	...
	void			(*exec_callback)(char *, MIList *);
	void			(*status_callback)(char *, MIList *);
	void			(*notify_callback)(char *, MIList *);
...
extern void MISessionRegisterExecCallback(MISession *sess, void (*callback)(char *, MIList *));
extern void MISessionRegisterStatusCallback(MISession *sess, void (*callback)(char *, MIList *));
extern void MISessionRegisterNotifyCallback(MISession *sess, void (*callback)(char *, MIList *));
